...
using FlutnetDialer.Services;

namespace FlutnetDialer
{
    public partial class ViewController : FlutterViewController
    {
        ...
        public override async void ViewDidAppear(bool animated)
        {
            ...
            //FlutnetDialer.PluginInterop.GeneratedPluginRegistrant.Register(this.Engine);

            try
            {
                FlutnetRuntime.Init("TRIAL-APP-KEY");
                FlutnetRuntime.RegisterPlatformService(new DialerServiceIOS(), "dialer_service");
