...
//         NOT EDIT THIS FILE          *
// *************************************
// IMPORT FILE: import 'package:flutnet_errors_bridge/flutnet/service_model/platform_operation_exception.dart';
// *************************************
import 'package:json_annotation/json_annotation.dart';
import 'package:meta/meta.dart';
import 'package:flutnet_errors_bridge/flutnet/data/flutnet_exception.dart';
...
class PlatformOperationException extends Object implements Exception {
	...
	static final Map<Type, String> 	_platformOperationExceptionToType = {
		...
		LoginException().runtimeType : "FlutnetErrors.ServiceLibrary.Errors.LoginException, FlutnetErrors.ServiceLibrary",
	};
